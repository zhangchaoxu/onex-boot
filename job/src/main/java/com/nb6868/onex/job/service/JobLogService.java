...
import com.nb6868.onex.sys.dao.JobLogDao;
import com.nb6868.onex.sys.dto.JobLogDTO;
import com.nb6868.onex.sys.entity.JobLogEntity;
...
public class JobLogService extends DtoService<JobLogDao, JobLogEntity, JobLogDTO> {
    ...
    @Override
    public QueryWrapper<JobLogEntity> getWrapper(String method, Map<String, Object> params) {
        return new WrapperUtils<JobLogEntity>(new QueryWrapper<>(), params)
