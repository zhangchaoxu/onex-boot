    ...
    i.prototype.expand = function(treeNode, isOpened, e) {
        ...
        i.prototype.traverseModel = function(treeTable, parentNode, item, childrenAttrs) {
            ...
            layui.each(n, function(a, n) {
                ...
                var l = n.children && n.children.length > 0,
                    ...
                    s = o(["<li " + (n.spread ? 'data-spread="' + n.spread + '"' : "") + ">", function() {
                        ...
                        return '<a href="' + (n.href || "javascript:;") + '" ' + (i.target && n.href ? 'target="' + i.target + '"' : "") + ">" + ('<i class="layui-icon layui-tree-' + (l ? "branch" : "leaf") + '">' + (l ? n.spread ? t.branch[1] : t.branch[0] : t.leaf) + "</i>") + ("<cite>" + (n.title || "未命名") + "</cite></a>")
                    }(), "</li>"].join(""));
                l && (s.append(c), r.tree(c, n.children)), e.append(s), "function" == typeof i.click && r.click(s, n), r.spread(s, n), i.drag && r.drag(s, n)
                r.changed(s, n)
            })
        }, i.prototype.treeGrid = function(e, a) {
            var r = this,
                i = r.options,
                n = a || i.nodes,
            ...
            layui.each(n, function(a, n) {
                ...
                e.append(str), index++, l && (r.treeGrid(e, n.children)), r.spreadGird(str, n), i.drag && r.drag(str, n)
                r.changed(str, n)
            })
