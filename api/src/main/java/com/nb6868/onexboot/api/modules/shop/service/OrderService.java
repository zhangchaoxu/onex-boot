 ...
 */
@Service
public class OrderService extends DtoService<com.nb6868.onexboot.api.modules.shop.dao.OrderDao, OrderEntity, OrderDTO> {
    ...
    @Autowired
    com.nb6868.onexboot.api.modules.pay.service.OrderService payOrderService;
    @Autowired
    ...
    public Serializable pay(PayRequest payRequest) {
        ...
        // 存入PayOrder
        // 判断payorder是否存在
        com.nb6868.onexboot.api.modules.pay.entity.OrderEntity payOrder = payOrderService.getByOrderId("shop_order", payRequest.getOrderId(), order.getPayType());
        if (null == payOrder) {
            payOrder = new com.nb6868.onexboot.api.modules.pay.entity.OrderEntity();
