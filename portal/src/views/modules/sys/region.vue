  ...
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-sys__region">
      ...
      <el-table v-loading="dataListLoading" :data="dataList" border @selection-change="dataListSelectionChangeHandle" style="width: 100%;" row-key="id" lazy :load="load">
        ...
        <el-table-column prop="code" label="区号" header-align="center" align="center"/>
        <el-table-column prop="postcode" label="邮编" header-align="center" align="center"/>
        <el-table-column prop="deep" label="级别" header-align="center" align="center"/>
